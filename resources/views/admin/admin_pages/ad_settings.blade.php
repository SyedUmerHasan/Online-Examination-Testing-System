            ...
            <div class="col-md-12">
              ...
              <div class="card">
                <div class="card-header">
                  ...
                  <br/>
                  {{--  Line Change  --}}
                  <h4 class="card-title">Change Your Admin Username</h4>
                ...
                <div class="card-content collapse show">
                  <div class="card-body">
                    ...
                    <form class="form-horizontal" novalidate method="POST" action="{{ url('/admin/updateusername') }}">
                      {{ csrf_field() }}
                      <div class="row">
                        <div class="col-lg-12 col-md-12">
                          <div class="form-group">
                            <h5>Current User Name
                              <span class="required">*</span>
                            </h5>
                            <div class="controls">
                              <input type="text" name="currentusername" id="currentusername" class="form-control" required data-validation-required-message="This field is required">
                            </div>
              ...
              <div class="card">
                <div class="card-header">
                  ...
                  <br/>
                  {{--  Line Change  --}}
                  <h4 class="card-title">Change Your Admin Password</h4>
                  <a class="heading-elements-toggle"><i class="la la-ellipsis-v font-medium-3"></i></a>
                  <div class="heading-elements">
                    {{--  <ul class="list-inline mb-0">
                      <li><a data-action="collapse"><i class="ft-minus"></i></a></li>
                ...
                <div class="card-content collapse show">
                  <div class="card-body">
                    {{--  <p>Add <code>novalidate</code> attribute to form tag.</p>  --}}
                    <form class="form-horizontal" novalidate method="POST" action="{{ url('/admin/updatepassword') }}">
                      {{ csrf_field() }}
                      <div class="row">
                        <div class="col-lg-12 col-md-12">
                          <div class="form-group">
                            ...
                            <div class="controls">
                              <input type="password" name="currentpassword" id="currentpassword" class="form-control" required data-validation-required-message="This field is required">
                            </div>
