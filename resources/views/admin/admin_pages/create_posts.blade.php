            ...
            <div class="col-12">
              <div class="card">
                ...
                <div class="card-content collapse show">
                  <div class="card-body">
                    <form class="form form-horizontal form-bordered" method="POST" action="{{ url('/admin/addposts') }}">
                      {{csrf_field()}}
                      <div class="form-body">
                        ...
                        <div class="row">
                          ...
                          <div class="col-md-6">
                            <div class="form-group row">
                              <label class="col-md-3 label-control" for="PageHomePriority">Post Category</label>
                              <div class="col-md-9">
                                <select name="postscategory" id="postscategory" class="form-control border-primary">
                        ...
                        <div class="row">
                          ...
                          <div class="col-md-9">
                            <div class="form-group row last">
                              <label class="col-md-2 label-control" for="PostSummary">Post Tags</label>
                              <div class="col-md-10">
                              <input name="tags" class="form-control border-primary" data-role="tagsinput" id="input-tags"/>
