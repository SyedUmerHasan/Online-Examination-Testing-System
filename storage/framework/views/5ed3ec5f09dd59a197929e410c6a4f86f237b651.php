                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-content collapse show">
                            <div class="card-body">
                                <form class="form form-horizontal form-bordered" class="repeater" method="POST" action="<?php echo e(url('/admin/addposts')); ?>">
                                            ...
                                            <div class="form-group row last">
                                                ...
                                                <div class="col-md-10">
                                                    <select name="TestCategory" id="TestCategory" class="form-control border-primary">
                                                        ...
                                                        <option value="<?php echo e($item->category_text); ?>"><?php echo e($item->category_text); ?></option>   
