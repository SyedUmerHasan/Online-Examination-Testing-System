                            ...
                            <div class="card-body">
                                        ...
                                        <div class="form-group row last">
                                            ...
                                            <div class="col-md-10">
                                                <select name="TestCategory" id="TestCategory" class="form-control border-primary">
                                                    ...
                                                    <option value="<?php echo e($item->category_text); ?>" class="category"><?php echo e($item->category_text); ?></option>   
                                ...
                                <?php if(count($test) >  0): ?>
                                    <?php $__currentLoopData = $test; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <b><h3><?php echo $i+1; ?>   <?php echo e(')'); ?>  <?php echo e($item->test_question); ?></h3></b>
                                        <ul>
                                          <?php $__currentLoopData = $item->options; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item2): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                              <h4><li><?php echo e($item2->answer_title); ?></li></h4>
                                          <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                        </ul>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
