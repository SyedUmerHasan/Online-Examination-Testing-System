...
<body class="stretched">
    ...
    <div id="wrapper" class="clearfix">
        ...
        <?php echo $__env->make('Test.inc.header', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
        ...
        <section id="content">
            <div class="content-wrap">
                <div class="container clearfix">
                    ...
                    <div class="col_full">
                            <?php if(empty($correctresult) || empty($wrongresult) || empty($skippedresult)): ?>
                    ...
                    <?php if(!empty($test)): ?>
                        <?php if(count($test) >  0): ?>
                            <form class="form form-horizontal form-bordered" id="submittest" class="repeater" method="POST" action="<?php echo e(url('/submittest')); ?>">
                            ...
                            <input type="hidden" name="usertestid" id="usertestid" value="<?php echo e(Session::get('usertestid')); ?>">
