...
<ul class="nav navbar-nav float-right">
  <li class="dropdown dropdown-user nav-item">
    ...
    <div class="dropdown-menu dropdown-menu-right"><a class="dropdown-item" href="#"><i class="ft-user"></i> Edit Profile</a>
      <a class="dropdown-item" href="/admin/settings"><i class="ft-mail"></i> Settings</a>
  ...
  <li class="dropdown dropdown-notification nav-item">
    <a class="nav-link nav-link-label" href="#" data-toggle="dropdown"><i class="ficon ft-bell"></i>
      <?php if(auth()->user()->unreadNotifications->count() > 0): ?>
        <span class="badge badge-pill badge-default badge-danger badge-default badge-up badge-glow"><?php echo e(auth()->user()->unreadNotifications->count()); ?></span>
      <?php endif; ?>
    </a>
    <ul class="dropdown-menu dropdown-menu-media dropdown-menu-right">
      <li class="dropdown-menu-header">
        ...
        <?php if(auth()->user()->unreadNotifications->count() > 0): ?>
          <span class="notification-tag badge badge-default badge-danger float-right m-0"><?php echo e(auth()->user()->unreadNotifications->count()); ?> New</span>
        <?php endif; ?>
      </li>
        ...
        <a href="javascript:void(0)">
          <div class="media" style="background:#F2F2F2; border-radius:5px;">
            ...
            <div class="media-body">
              <h6 class="media-heading"><?php echo e($notification->data['title']); ?></h6>
              <p class="notification-text font-small-3 text-muted"><?php echo e($notification->data['body']); ?></p>
              <small>
      ...
      <li class="dropdown-menu-footer"><a class="dropdown-item text-muted text-center" href="<?php echo e(route('MarkAllAsRead')); ?>">Read all notifications</a></li>
    </ul>
  </li>
  <li class="dropdown dropdown-notification nav-item">
